...
public class SignInController implements Initializable {
    ...
    private void onSignInBtnClick(ActionEvent event) {
        ...
        if (!isFormValid()) {
            ...
            showErrorDialog("Les mots de passes entrés ne sont pas identiques. Il est nécéssaire de mettre un mot de passes de 8 charactères minimum dont 1 majuscule, 1 chiffre et 1 symbole");
